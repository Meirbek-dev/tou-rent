...
Do not default to: AI-purple gradients, centered hero over dark mesh, three equal feature cards, generic glassmorphism on everything, infinite-loop micro-animations everywhere, slate-900. These are the LLM defaults. Reach past them deliberately based on the design read.
